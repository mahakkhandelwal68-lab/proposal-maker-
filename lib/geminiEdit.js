...
If the request maps cleanly onto one or more of these lines (e.g. changing a price, removing/rewording a bullet, changing a package name), return those as edits.

If the request cannot be safely mapped onto an exact existing line (e.g. it asks to add something entirely new, or is ambiguous, or requires restructuring), do NOT guess — leave edits empty and explain what needs manual attention in "note".
